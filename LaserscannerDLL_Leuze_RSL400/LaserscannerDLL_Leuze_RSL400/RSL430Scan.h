...
public:
	...
	int getSingleScan( std::list<SPunkt>& lcpPoints, std::list<double>& ldTimeStamps );

	int getRecordedScanPoints( std::list<SPunkt>& lcpRecPoints, std::list<double>&ldRecTimeStamps );
