...
int C3DCalc::Save3D(std::list<SPunkt> liPunkte, string sDatName)
{
	int iReturn = -1;
	std::fstream outScan;
	outScan.open(sDatName.c_str(), ios::out);
	if (outScan.is_open())
	{
