...
extern "C" {
	ROTOSCAN_API int initLaScanLib(unsigned int* iHandle, const char* szHostName, unsigned int uiPortNumber);
	ROTOSCAN_API int exitLaScanLib(unsigned int iHandle);
	...
	ROTOSCAN_API int getRecordedScanPoints(unsigned int iHandle, std::list <SPunkt>& rlstclPoints, std::list <double>& rlstdTimeStamps, bool bInterpoleateTimeStamps);
