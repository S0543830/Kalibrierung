...
public:
	...
	static int GetWertAusXML_Str( const char* XMLPfad, string* ReturnParameter, int Parameter, ... );
	...
	static int XMLLesen(vector<string> vParameterListe, const char* XMLPfad, string* ReturnParameter );
