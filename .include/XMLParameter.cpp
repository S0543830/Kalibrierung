...
{
	va_list ap;
	std::vector<std::string> vParameterListe;
	std::string sTmp;
	int iUmwandlung;
	int iResult = 0;
	...
	{
		std::cout << "Bei Optionsparameter: " << vParameterListe.at(vParameterListe.size()-1) << ", ist ein Fehler aufgetreten" << std::endl;
		sTmp = "";
	}
...
/* Erfolgreich war oder nicht											*/
/************************************************************************/
int CXMLParameter::GetWertAusXML_Str( const char* XMLPfad, std::string* ReturnParameter, int Parameter, ... )
{
	va_list ap;
	std::vector<std::string> vParameterListe;
	std::string sTmp;
...
/************************************************************************/
/************************************************************************/
int CXMLParameter::XMLLesen(std::vector<std::string> vParameterListe, const char* XMLPfad, std::string* ReturnParameter )
{
	xmlDoc* doc = NULL;
